  ...
  skills: [
    {
      ...
      category: "Front-End",
      skills: [
        { id: "s1-1", name: "React Vite", percent: 95 },
        { id: "s1-2", name: "Tailwind CSS", percent: 98 },
        { id: "s1-3", name: "TypeScript", percent: 90 },
      ],
    },
    {
      id: "s2",
      category: "Back-End",
      skills: [
        { id: "s2-1", name: "Node.js", percent: 88 },
        { id: "s2-2", name: "PostgreSQL", percent: 82 },
        { id: "s2-3", name: "GraphQL", percent: 85 },
      ],
    },
    {
      id: "s3",
      category: "DevOps",
      skills: [
        { id: "s3-1", name: "Docker", percent: 88 },
        { id: "s3-3", name: "GitHub", percent: 75 },
        { id: "s3-2", name: "Postman", percent: 92 },
      ],
    },
  ],
  projects: [
    ...
    },
    {
      ...
      tags: ["React Native", "Expo", "WebSockets", "Node.js"],
